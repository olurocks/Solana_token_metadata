...
async function main(){
    ...
    const myKeypair = loadWalletKey("woJAkGjEJ5NvXADHctjHfcmgN7PvWACvLx4YaxbNNNf.json");
    const mint = new web3.PublicKey("WoJak6xhuQQFW2Tz7ZeTEG9pHdyCMMZQiwhfdv6zrCX");
    ...
    const ourMetadata = { // TODO change those values!
        name: "Wojak On Sol", 
        symbol: "$WOJAK",
        uri: "https://raw.githubusercontent.com/olurocks/CSV_TO_JSON/main/metadata.json",
    }
    const onChainData = {
        ...ourMetadata,
        // we don't need that
